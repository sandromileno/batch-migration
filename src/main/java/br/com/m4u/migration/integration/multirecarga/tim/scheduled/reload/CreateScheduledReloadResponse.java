...
/**
 * Created by sandro on 17/11/16.
 */
public class CreateScheduledReloadResponse {
    ...
    public CreateScheduledReloadResponse() {
    }

    public CreateScheduledReloadResponse(HttpStatus statusCode, String message) {
